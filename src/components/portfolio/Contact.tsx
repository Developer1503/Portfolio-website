...
import { Mail, Phone, MapPin, Github, Linkedin, Send, Download, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'vedantshinde305@example.com',
      link: 'mailto:vedantshinde305@example.com'
    },
    {
      icon: <Phone className="h-5 w-5" />,
      label: 'Phone',
      value: '+91 86524 00980',
      link: 'tel:+918652400980'
    },
    {
  ...
  const socialLinks = [
    {
      ...
      label: 'GitHub',
      url: 'https://github.com/Developer1503',
    ...
    },
    {
      icon: <Mail className="h-5 w-5" />,
      label: 'Email',
      url: 'mailto:vedant.shinde@example.com',
          ...
          <div className="fade-on-scroll space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                Whether you're interested in collaborating on AI/ML projects, 
                discussing technology, or exploring new opportunities, 
                I'm always excited to connect with fellow innovators and professionals.
              </p>
            </div>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full btn-hero group text-lg py-3"
                  >
                    {isSubmitting ? (
                      <>
